...
@section('content')
    ...
    <div class="flex gap-4 py-4 px-4">
        ...
        <div class="flex-initial">
            <a href="#" style="pointer-events: none; cursor: default;"
                class="block p-6 max-w-sm bg-white rounded-lg border border-gray-200 shadow-md hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
                <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Jumlah Pengajuan
                    Outstanding
                </h5>
        ...
        <div class="flex-initial">
            <a href="#" style="pointer-events: none; cursor: default;"
                class="block p-6 max-w-sm bg-white rounded-lg border border-gray-200 shadow-md hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
                <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Jumlah Pengajuan Permit
                </h5>
