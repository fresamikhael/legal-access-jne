    ...
    <div class="flex flex-col white">
        ...
        <div class="mx-1 outline outline-offset-0 outline-2">
            ...
            <div class="bg-[#808080] grid grid-flow-row auto-rows-max grid grid-flow-col auto-cols-max py-1">
                ...
                <h1 class="text-white">AGREEMENT NUMBER</h1>
            </div>
            <div class="grid grid-flow-row auto-rows-max py-1">
                <h1 class="text-black grid place-items-center">test case</h1>
            </div>
            <div class="bg-[#808080] grid grid-flow-row auto-rows-max grid grid-flow-col auto-cols-max py-1">
                ...
                <h1 class="text-white">CUSTOMER/AGENT</h1>
            </div>
            <div class="grid grid-flow-row auto-rows-max py-1">
                <h1 class="text-black grid place-items-center">test case</h1>
            </div>
                            ...
                            <div class="grid grid-rows-4 grid-flow-col col-span-3">
                                <div class="col-span-2">
                                    <div class="flex my-2 place-items-center">
                                        <label for="text"
                                            class="flex  flex-initial w-15 mr-20  items-center text-md font-medium text-gray-900 dark:text-gray-300 grid">Rekap
                                            Data</label>
                                ...
                                <div class="col-span-2">
                                    <div class="flex my-2 place-items-center">
                                        <label for="text"
                                            class="flex flex-initial w-15 mr-20 items-center text-md font-medium text-gray-900 dark:text-gray-300 grid">Bukti
                                            Dokumen</label>
                                        <a href="your link here"><i class="fas fa-arrow-alt-circle-down fa-3x"></i></a>
                                    </div>
                                </div>
                                <div class="col-span-2">
                                    <div class="flex my-2 place-items-center">
                                        <label for="text"
                                            class="flex flex-initial w-15 mr-20 items-center text-md font-medium text-gray-900 dark:text-gray-300 grid">Perjanjian</label>
                                        <a href="your link here"><i class="fas fa-arrow-alt-circle-down fa-3x"></i></a>
                                    </div>
                                </div>
                                <div class="col-span-2">
