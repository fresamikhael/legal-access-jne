    ...
    <div class="flex flex-col white">
        ...
        <div class="mx-1 outline outline-offset-0 outline-2">
            ...
            <div class="bg-[#808080] grid grid-flow-row auto-rows-max grid grid-flow-col auto-cols-max py-1">
                ...
                <h1 class="text-white">DOCUMENT NUMBER</h1>
            </div>
            <div class="grid grid-flow-row auto-rows-max py-1">
                <h1 class="text-black grid place-items-center">test case</h1>
            </div>
            <div class="bg-[#808080] grid grid-flow-row auto-rows-max grid grid-flow-col auto-cols-max py-1">
                ...
                <h1 class="text-white">PARTIES</h1>
            </div>
            <div class="grid grid-flow-row auto-rows-max py-1">
                <h1 class="text-black grid place-items-center">test case</h1>
            </div>
            ...
            <div class="mx-20 my-5">
                ...
                <div class="grid grid-rows-2 grid-flow-col gap-4 mb-4">
                    <div class="row-span-4 grid gap-4">
                        <div class="grid grid-cols-4 grid-flow-col">
                            <div class="font-medium col-span-1">Bukti :</div>
                            <div class="grid grid-rows-4 grid-flow-col col-span-3">
                                <div class="col-span-2">
                                    <div class="flex my-2 place-items-center">
                                        <label for="text"
                                            class="flex  flex-initial w-15 mr-20  items-center text-md font-medium text-gray-900 dark:text-gray-300 grid">Dokumen</label>
                                ...
                                <div class="col-span-2">
                                    <div class="flex my-2 place-items-center">
                                        <label for="text"
                                            class="flex flex-initial w-15 mr-20 items-center text-md font-medium text-gray-900 dark:text-gray-300 grid">Bukti 1</label>
                                        <a href="your link here"><i class="fas fa-arrow-alt-circle-down fa-3x"></i></a>
                                    </div>
                                </div>
                                <div class="col-span-2">
                                    <div class="flex my-2 place-items-center">
                                        <label for="text"
                                            class="flex flex-initial w-15 mr-20 items-center text-md font-medium text-gray-900 dark:text-gray-300 grid">Bukti 2</label>
                                        <a href="your link here"><i class="fas fa-arrow-alt-circle-down fa-3x"></i></a>
                                    </div>
                                </div>
                                <div class="col-span-2">
                                    <div class="flex my-2 place-items-center">
                                        <label for="text"
                                            class="flex flex-initial w-15 mr-20 items-center text-md font-medium text-gray-900 dark:text-gray-300 grid">Bukti 3</label>
                                        <a href="your link here"><i class="fas fa-arrow-alt-circle-down fa-3x"></i></a>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="flex flex-col gap-4 mb-4">
                    <div class="flex my-5 place-items-center">
                        <label for="text"
                            class="flex flex-initial w-15 mr-20 items-center text-md font-medium text-gray-900 dark:text-gray-300 grid">Disposisi</label>
                        <a href="your link here"><i class="fas fa-arrow-alt-circle-down fa-3x"></i></a>
                    </div>
                    <div class="flex mb-5 place-items-center">
                        <label for="text"
                            class="flex flex-initial w-15 mr-20 items-center text-md font-medium text-gray-900 dark:text-gray-300 grid">Dokumen Lainnya</label>
                        <a href="your link here"><i class="fas fa-arrow-alt-circle-down fa-3x"></i></a>
                    </div>
