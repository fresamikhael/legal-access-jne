            ...
            <div class="mx-20">
                        ...
                        <div class="grid grid-cols-4 grid-flow-col">
                            ...
                            <div class="grid grid-rows-4 grid-flow-col col-span-3">
                                ...
                                <div class="col-span-2">
                                    <div class="flex my-2 place-items-center">
                                        <label for="text"
                                            class="flex flex-initial w-15 mr-20 items-center text-md font-medium text-gray-900 dark:text-gray-300 grid">Dokumen
                                            Surat</label>
                                        <a href="your link here"><i class="fas fa-arrow-alt-circle-down fa-3x"></i></a>
                                    </div>
                                </div>
                ...
                <div class="flex flex-col gap-4 mb-4">
                    ...
                    <div class="flex place-items-center">
                        <label for="text"
                            class="flex flex-initial w-15 mr-20 items-center text-md font-medium text-gray-900 dark:text-gray-300 grid">Kelengkapan</label>
                        <a href="your link here"><i class="fas fa-arrow-alt-circle-down fa-3x"></i></a>
                    </div>
                    <div class="flex my-5 place-items-center">
                        <label for="text"
