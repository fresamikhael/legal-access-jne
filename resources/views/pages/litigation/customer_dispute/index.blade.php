...
@section('content')
            ...
            <div class="grid grid-cols-2 gap-16 mb-4">
                <div class="flex flex-col gap-4">
                    ...
                    <div class="flex">
                        ...
                        <div class="flex-[4]">
                            <input type="text" id="text" name="first_party"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-md rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                placeholder="Masukkan Kodepos" required>
                        </div>
                    </div>
                    <div class="flex">
                        <label for="text"
                ...
                <div class="flex flex-col gap-4">
                    ...
                    <div class="flex">
                        ...
                        <div class="flex-[4]">
                            <select required name="assurance" onchange="assurance(this);"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                <option value="" style="display: none">-- Pilih --</option>
                                <option>Ya</option>
                                <option>Tidak</option>
                    ...
                    <div id="ifYesAssurance" style="display: none;">
                        <div class="flex">
                            <label for="text"
                                class="flex items-center flex-[3] mb-2 text-md font-medium text-gray-900 dark:text-gray-300"></label>
                            <div class="flex-[4]">
    ...
    <script>
        ...
        function assurance(that) {
            if (that.value == "Ada") {
                // alert("check");
                document.getElementById("ifYesAssurance").style.display = "block";
            } else {
                document.getElementById("ifYesAssurance").style.display = "none";
            }
        }
    </script>
@endsection
